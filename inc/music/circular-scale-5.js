...
let target, drawingCommands ;  // Drawing commands
...
export function createCircularScale ( t, o, ...rest ) {
    ...
    for ( let i = 0 ; i < drawingCommands.length ; i ++ ) {
        ...
        case "circle" :
            ...
            break;
        case "spiral" :
            target.appendChild( spiral ( 0, 0, dcmd.d/2, dcmd.ript, -90, dcmd.steps*30-90, 30, dcmd.eas ));
            break;
        case "ticklines" :
